...
export default function Home() {
  return (
    <main className={`${inter.className} z-10 bg-black text-white antialiased relative min-h-screen`}>
      {/* Blobs Background */}
      <div className="fixed inset-0 -z-50">
        <div className="absolute rounded-full mix-blend-lighten filter blur-3xl opacity-60 animate-blob -z-40 blob-1 top-10 left-20 w-64 h-64 bg-[#1000DE]/40"></div>
        <div className="absolute rounded-full mix-blend-lighten filter blur-3xl opacity-60 animate-blob -z-40 blob-2 bottom-20 right-32 w-80 h-80 bg-[#1000DE]/30"></div>
        <div className="absolute rounded-full mix-blend-lighten filter blur-3xl opacity-60 animate-blob -z-40 blob-3 top-1/3 right-1/4 w-96 h-64 bg-[#1000DE]/20 rotate-45"></div>
      </div>
        ...
        <header className="py-6">
          <nav className="flex items-center justify-between">
            ...
            <a href="#!" className="flex items-center space-x-2 flex-shrink-0">
              ...
              <span className="text-xl font-bold whitespace-nowrap">upward studio</span>
            </a>

            {/* Navigation */}
            <div className="hidden md:flex items-center space-x-2 bg-gray-900/50 border border-gray-700/50 rounded-full px-2 py-1 mx-4">
              <a href="#!" className="px-4 py-2 text-sm font-medium bg-gray-700/50 rounded-full whitespace-nowrap">Upward Studio</a>
            ...
            <div className="hidden md:block">
              <a href="#!" className="px-5 py-2.5 text-sm font-semibold text-gray-900 bg-white rounded-lg hover:bg-gray-200 transition-colors whitespace-nowrap">
                Contact Us
              </a>
            </div>
          </nav>
